...
public class AppCustomController extends AbstractController{
    ...
    public JsonResult add(@RequestParam("question") String question, @RequestParam("answer") String answer){
        AppCustom appCustom = new AppCustom();
        appCustom.setQuestion(question);
        appCustom.setAnswer(answer);
        appCustom.setInputtime(System.currentTimeMillis());
        return appCustomService.add(appCustom);
    }

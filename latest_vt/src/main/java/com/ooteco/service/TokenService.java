...
public class TokenService {
    ...
    public Integer decryptTokenUserId(String token){
        String decryptStr = aesDecrypt(token);
        return Integer.parseInt(decryptStr.split(delimiter)[0]);
    }
    ...
    public static void main(String[] args) throws Exception{
        String encrypt = new TokenService().encrypt(5, System.currentTimeMillis());

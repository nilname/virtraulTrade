...
create table vt_info_weibo   (id int NOT NULL,name varchar(255), createtime datetime,  content text ) engine=InnoDB default charset=utf8;
create table vt_info_twitter (id int NOT NULL,name varchar(255), createtime datetime,  content text ) engine=InnoDB default charset=utf8;
create table vt_info_niuren (id int NOT NULL,name varchar(255), createtime datetime,  content text ,source varchar(64) ) engine=InnoDB default charset=utf8;
create table vt_info_news (id int NOT NULL, createtime datetime,  content text ,sourceurl varchar(255),source varchar(255)) engine=InnoDB default charset=utf8;
create table vt_info_block_news (id int auto_increment primary key,title text, author varchar(255),newstime datetime,  newsuri varchar(255) ) engine=InnoDB default charset=utf8;
